          ...
          <FieldGroup>
            <Field>
              ...
              <div className="flex w-full py-2" onBlur={onCodeBlur}>
                ...
                >
                  <InputOTPGroup className="w-full gap-2.5 *:data-[slot=input-otp-slot]:h-10 *:data-[slot=input-otp-slot]:min-w-0 *:data-[slot=input-otp-slot]:flex-1 *:data-[slot=input-otp-slot]:rounded-md *:data-[slot=input-otp-slot]:border">
